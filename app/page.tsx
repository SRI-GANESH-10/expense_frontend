...
export default function Home() {
  return (
    <div className="w-[30%] h-full mt-10 ml-10 bg-slate-300 border border-black flex flex-col">
      ...
      <CustomInput placeholder="Enter Username/Email" className="border-2 border-zodiac rounded-md"></CustomInput>
